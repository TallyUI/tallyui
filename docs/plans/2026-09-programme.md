...
| 38 | **A hidden live tab hands over promptly.** Chrome slows timers to about once a minute in a tab that has been hidden for more than 5 minutes. So when a busy live tab gets a hand-over request, its deferral can overshoot by up to about 60 s, even with the wall-clock cap from #78. Meanwhile the new tab shows "blocked" from 13 s (added 2026-09-24, from the #78 review) |
