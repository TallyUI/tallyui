...
function useRootContext(): RootContextType {
  ...
  if (!context) {
    throw new Error(
      'ContextMenu compound components cannot be rendered outside the ContextMenu.Root component'
    );
  }
  return context;
}
...
function useFormItemContext(): FormItemContext {
  ...
  if (!context) {
    throw new Error(
      'ContextMenu.ItemIndicator must be rendered inside a CheckboxItem or RadioItem'
    );
  }
  return context;
}
...
function useSubContext() {
  ...
  if (!context) {
    throw new Error(
      'ContextMenu.Sub compound components cannot be rendered outside a ContextMenu.Sub component'
    );
  }
  return context;
}
...
const Trigger = React.forwardRef<View, TriggerProps>(function Trigger(
  { asChild, onLongPress: onLongPressProp, disabled, ...props },
  ref
) {
  ...
  const onLongPress = React.useCallback(
    ...
    [augmentedRef, disabled, onOpenChange, onLongPressProp, open, setTriggerPosition]
  );
...
Portal.displayName = 'ContextMenuPortal';
...
Overlay.displayName = 'ContextMenuOverlay';
...
ItemIndicator.displayName = 'ContextMenuItemIndicator';
...
Sub.displayName = 'ContextMenuSub';
