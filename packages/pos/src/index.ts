...
export { RegisterSessionRequiredError, openSessionSelector, requireOpenSession, openSession, startCounting, backToSelling, closeSession, recordMovement, voidMovement, writeClosure } from './register';
